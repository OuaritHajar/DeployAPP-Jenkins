<template>
    ...
    <!-- Home -->
    <router-link :to="{name: 'Home', params: {limit: 10} }" class="navbar-brand">
    ...
    <div class="collapse navbar-collapse justify-content-end" id="navbarToggler">
      <div v-if="user.userId > -1 ">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <router-link :to="{name: 'Mur', params: {limit: 10} }" class="nav-link">
              Forum
            </router-link>
          </li>
          ...
          <li class="nav-item">
            <router-link :to="{name:'Home', params: {limit:10}}" @click="logout" class="nav-link">
                Déconnection
            </router-link>
          </li>
