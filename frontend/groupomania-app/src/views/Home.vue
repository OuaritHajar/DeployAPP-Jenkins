...
<div id="app">
  ...
  <main>
    <div v-if="$store.state.user.userId < 1 " class="presentation">
      ...
      <p class="text-center">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptatibus nam eos hic nobis blanditiis pariatur natus a harum, quos consectetur aperiam dolore ratione libero deleniti nemo numquam soluta dicta porro.</p>
